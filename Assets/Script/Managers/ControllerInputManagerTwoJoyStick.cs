...
public class ControllerInputManagerTwoJoyStick : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ((Input.GetKeyDown(joy1Confirm) && bm.turnManager.CurrentPlayerTurn == bm.p1Faction) || ((Input.GetKeyDown(joy2Confirm) && bm.turnManager.CurrentPlayerTurn == bm.p2Faction))) && bm.TutorialInProgress && !bm.pause)
        {
